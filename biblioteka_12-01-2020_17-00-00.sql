...
INSERT INTO `audiobook` VALUES (5,20);
...
CREATE TABLE `autor` (
  ...
  `krajPochodzenia` varchar(50) COLLATE utf8_polish_ci DEFAULT NULL,
...
INSERT INTO `autor` VALUES (1,'Adam','Mickiewicz','Polska'),(2,'Henryk','Sienkiewicz','Polska'),(3,'Bolesław','Prus','Polska'),(4,'Johan','Goethe','Niemcy'),(5,'Albert','Camus','Francja'),(6,'Olga','Tokarczuk',''),(7,'Tadeusz','Borowski','Polska'),(8,'Julian','Tuwim','Polska'),(9,'William','Shakespeare','Anglia'),(10,'Bolesław','Prus','Polska'),(11,'aaa','aaa','aaa'),(12,'Raz','Dwa','Trzy'),(13,'111','222','333'),(14,'Zbigniew','Herbert','Polska'),(15,'Fiodor','Dostojewski','Rosja');
...
INSERT INTO `dzial` VALUES (1,'klasyka'),(2,'epika'),(3,'liryka'),(4,'dramat'),(5,'nauki matematyczno-p'),(6,'informatyka'),(7,'ekonomia'),(8,'języki obce'),(9,'psychologia i socjol'),(10,'medycyna'),(11,'aabbcc'),(12,'TestowyDzial');
...
CREATE TABLE `egzemplarz` (
  ...
  `wycofany` tinyint(1) NOT NULL DEFAULT '0',
...
INSERT INTO `egzemplarz` VALUES (93,20,0),(94,20,0),(95,20,0),(96,20,0),(97,7,0),(98,7,0),(99,7,0),(100,7,0),(101,7,0),(102,7,0);
...
INSERT INTO `historiawypozyczenzwrotow` VALUES (25,43),(25,42),(25,41),(25,40),(25,39),(25,38),(25,37),(25,36),(25,44),(25,45),(25,46),(25,47),(25,48);
...
INSERT INTO `konto` VALUES (25,'Przemek','202cb962ac59075b964b07152d234b70','przemek@papla.pl','2019-12-26',2),(26,'Aga','202cb962ac59075b964b07152d234b70','studentkaa@pk.edu.pl','2019-12-26',1),(27,'Jan','202cb962ac59075b964b07152d234b70','student@gmail.com','2020-01-05',2);
...
INSERT INTO `koszyk` VALUES (25,'Pan Cogito'),(25,'Zbrodnia i Kara'),(25,'Lalka'),(27,'Zbrodnia i Kara'),(27,'Zbrodnia i Kara');
...
CREATE TABLE `ksiazka` (
  ...
  `sygnatura` varchar(15) COLLATE utf8_polish_ci NOT NULL,
  ...
  `slowoKlucz` varchar(50) COLLATE utf8_polish_ci DEFAULT NULL,
  `wycofana` tinyint(1) NOT NULL DEFAULT '0',
...
INSERT INTO `ksiazka` VALUES (7,'1',1,1,1,'Pan Tadeusz','lektury','Mickiewicz',0),(8,'2',2,2,2,'Krzyżacy','historyczne','Grunwald',0),(9,'3',3,2,2,'Lalka','lektury','kapitalizm',0),(10,'4',4,2,2,'Cierpienia młodego Wertera','powieści epistolarne','Sturm und Drang',1),(20,'5',15,7,12,'Zbrodnia i Kara','brak','Raskolnikow',0);
...
CREATE TABLE `pracownik_bibliotekarz` (
  ...
  `pesel` varchar(32) COLLATE utf8_polish_ci NOT NULL,
...
) ENGINE=InnoDB AUTO_INCREMENT=1234567895 DEFAULT CHARSET=utf8 COLLATE=utf8_polish_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `pracownik_bibliotekarz` VALUES (1234567894,'12345678902','Agata','BbbbB','nickname',26);
...
CREATE TABLE `statusrezerwacji` (
  ...
  `statusRezerwacji` varchar(100) COLLATE utf8_polish_ci NOT NULL,
...
CREATE TABLE `uzytkownik_student_czytelnik` (
  ...
  `imie` varchar(32) COLLATE utf8_polish_ci NOT NULL,
  `nazwisko` varchar(32) COLLATE utf8_polish_ci NOT NULL,
  `wydzial` varchar(32) COLLATE utf8_polish_ci NOT NULL,
  `kierunek` varchar(32) COLLATE utf8_polish_ci NOT NULL,
  `id_konta` int(10) NOT NULL,
  PRIMARY KEY (`id_czytelnika`),
  UNIQUE KEY `pesel` (`pesel`),
  KEY `fk_uzytkownik_student_czytelnik_1_idx` (`id_konta`)
) ENGINE=InnoDB AUTO_INCREMENT=123456795 DEFAULT CHARSET=utf8 COLLATE=utf8_polish_ci COMMENT='pesel - PK,FK';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `uzytkownik_student_czytelnik` VALUES (123456793,'12345678901','Przemysław','Ppppp','WIEIK','Informatyka',25),(123456794,'12345678900','Janusz','Nowak','WIEIK','Informatyka',27);
...
INSERT INTO `wydawnictwo` VALUES (1,'PWN','Kraków','Polska'),(2,'Helion','Warszawa','Polska'),(3,'Politechnika Krakows','Kraków','Polska'),(4,'Politechnika Rzeszow','Rzeszów','Polska'),(5,'Pearson','Londyn','Anglia'),(6,'1','2','3'),(7,'MojeWydawnictwo','Kraków','Polska');
...
CREATE TABLE `wypozyczenie_zwrot` (
  ...
  `miejsceOdbioru` varchar(25) COLLATE utf8_polish_ci DEFAULT NULL,
...
INSERT INTO `wypozyczenie_zwrot` VALUES (36,96,25,1,NULL,'2020-01-12','2020-01-26',NULL,NULL,'2020-03-12'),(37,94,25,1,NULL,'2020-01-12','2020-01-26',NULL,NULL,'2020-03-12'),(38,102,25,1,NULL,'2020-01-12','2020-01-26',NULL,NULL,'2020-03-12'),(39,100,25,1,NULL,'2020-01-12','2020-01-26',NULL,NULL,'2020-03-12'),(40,98,25,1,NULL,'2020-01-12','2020-01-26',NULL,NULL,'2020-03-12'),(41,97,25,1,NULL,'2020-01-12','2020-01-26',NULL,NULL,'2020-03-12'),(42,101,25,1,NULL,'2020-01-12','2020-01-26',NULL,NULL,'2020-03-12'),(43,99,25,1,NULL,'2020-01-12','2020-01-26',NULL,NULL,'2020-03-12'),(44,97,25,1,NULL,'2020-01-12','2020-01-26',NULL,NULL,'2020-03-12'),(45,98,25,1,NULL,'2020-01-12','2020-01-26',NULL,NULL,'2020-03-12'),(46,99,25,1,NULL,'2020-01-12','2020-01-26',NULL,NULL,'2020-03-12'),(47,100,25,1,NULL,'2020-01-12','2020-01-26',NULL,NULL,'2020-03-12'),(48,101,25,1,NULL,'2020-01-12','2020-01-26',NULL,NULL,'2020-03-12'),(49,97,25,2,NULL,'2020-01-12','2020-01-26',NULL,NULL,'2020-03-12'),(50,98,25,2,NULL,'2020-01-12','2020-01-26',NULL,NULL,'2020-03-12'),(51,99,25,2,NULL,'2020-01-12','2020-01-26',NULL,NULL,'2020-03-12'),(52,100,27,2,NULL,'2020-01-12','2020-01-26',NULL,NULL,'2020-03-12'),(53,93,27,2,NULL,'2020-01-12','2020-01-26',NULL,NULL,'2020-03-12'),(54,94,27,2,NULL,'2020-01-12','2020-01-26',NULL,NULL,'2020-03-12');
...
-- Dump completed on 2020-01-12 17:00:22
